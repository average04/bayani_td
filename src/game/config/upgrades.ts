  ...
  lapulapu: [
    ...
    },
    {
      ...
      levels: [
        ...
        { name: 'Dizzying Spin', cost: 190, desc: 'Slow 0.75x / 1s', delta: { slow: { factor: 0.75, duration: 1 } } },
        { name: 'Tempest', cost: 360, desc: '+0.5 atk speed, Slow 0.7x / 1.5s', delta: { fireRate: 0.5, slow: { factor: 0.7, duration: 1.5 } } },
      ],
    },
  ],
  ...
  gabriela: [
    {
      ...
      levels: [
        ...
        { name: 'Revolution', cost: 380, desc: '+14 damage, +30 range', delta: { damage: 14, range: 30 } },
      ],
    },
    {
      name: 'Rapid Fire',
      levels: [
        ...
        { name: 'Katipunan Storm', cost: 400, desc: '+1.6 atk speed, +20 splash', delta: { fireRate: 1.6, splashRadius: 20 } },
      ],
    },
  ],
  ...
  bernardo: [
    ...
    },
    {
      ...
      levels: [
        ...
        { name: 'Staggering Blow', cost: 220, desc: 'Hits Slow 0.75x / 1s', delta: { slow: { factor: 0.75, duration: 1 } } },
        { name: 'Unstoppable', cost: 420, desc: '+1.0 atk speed, Slow 0.7x / 1.5s', delta: { fireRate: 1.0, slow: { factor: 0.7, duration: 1.5 } } },
      ],
    },
  ],
  ...
  diwata: [
    ...
    },
    {
      ...
      levels: [
        ...
        { name: "Forest's Grasp", cost: 400, desc: '+22 dmg, 80% root 1.2s', delta: { damage: 22, root: { chance: 0.8, duration: 1.2 } } },
      ],
    },
  ],
  ...
  apolaki: [
    {
      ...
      levels: [
        ...
        { name: 'Noonday Wrath', cost: 260, desc: '+60 damage', delta: { damage: 60 } },
        { name: "War God's Spear", cost: 480, desc: '+115 damage, +30 range', delta: { damage: 115, range: 30 } },
      ],
    },
    {
      name: 'Zenith',
  ...
  rizal: [
    {
      ...
      levels: [
        ...
        { name: 'El Filibusterismo', cost: 150, desc: 'Aura +22% dmg', delta: { aura: { damageAmp: 0.22 } } },
        { name: 'La Liga Filipina', cost: 280, desc: 'Aura +28% dmg, +15 range', delta: { aura: { damageAmp: 0.28 }, range: 15 } },
